...
1. **Integrate Embeddings into ChromaIndexer**
   - Open `src/antigravity_tool/repositories/chroma_indexer.py`.
...
2. **Expose Hybrid Search in KnowledgeGraphService**
   - Open `src/antigravity_tool/services/knowledge_graph_service.py`.
...
3. **Enhance Context Engine**
   - Open `src/antigravity_tool/services/context_engine.py`.
