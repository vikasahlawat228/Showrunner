...
This module provides the cross-session memory that makes Showrunner
...
class DecisionLog:
    ...
    def __init__(self, project_path: Path):
        self.state_dir = project_path / ".showrunner"
...
class SessionLog:
    ...
    def __init__(self, project_path: Path):
        self.sessions_dir = project_path / ".showrunner" / "sessions"
