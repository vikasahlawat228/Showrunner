"""Showrunner Studio API -- FastAPI application with router-based architecture.
...
from showrunner_tool.errors import ShowrunnerError
from showrunner_tool.server.error_handlers import showrunner_error_handler
...
async def lifespan(app: FastAPI):
    ...
    * ModelConfigRegistry (Phase F)
    ...
    from showrunner_tool.services.file_watcher_service import FileWatcherService
    ...
    from showrunner_tool.server.routers.project import broadcast_event
    ...
    chat_db_path = proj.path / ".showrunner" / "chat.db"
...
app = FastAPI(title="Showrunner Studio API", version="0.3.0", lifespan=lifespan)
...
app.add_exception_handler(ShowrunnerError, showrunner_error_handler)
...
from showrunner_tool.server.routers import jobs as jobs_router
