...
from showrunner_tool.schemas.project import (
    ProjectCreate,
    ProjectSettings,
...
from showrunner_tool.server.deps import (
...
async def update_project_settings(
    ...
    """Update project settings in showrunner.yaml."""
    from showrunner_tool.utils.io import read_yaml, write_yaml

    yaml_path = project.path / "showrunner.yaml"
