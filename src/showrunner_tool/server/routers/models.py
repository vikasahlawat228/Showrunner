...
model config, and updating overrides in showrunner.yaml.
"""
...
from showrunner_tool.schemas.model_config import (
    ModelConfigUpdate,
    ProjectModelConfig,
)
...
from showrunner_tool.server.deps import get_model_config_registry
...
async def update_model_config(
    ...
    """Update model overrides in showrunner.yaml and reload the registry."""
