"""showrunner timeline - chronological story timeline management."""
...
from showrunner_tool.schemas.timeline import Timeline, TimelineEvent, TimelineIssue
...
def show_timeline(
    ...
    if not timeline.events:
        print_info("Timeline is empty. Add events with 'showrunner timeline add'.")
        return
