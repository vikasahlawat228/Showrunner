"""showrunner relationship - character relationship graph management."""
...
from showrunner_tool.schemas.character import RelationshipEdge, RelationshipEvolution, RelationshipGraph
from showrunner_tool.utils.display import console, create_table, print_success, print_info, print_error
...
def list_relationships() -> None:
    ...
    if not graph.edges:
        print_info("No relationships defined. Use 'showrunner relationship add' to create one.")
        return
