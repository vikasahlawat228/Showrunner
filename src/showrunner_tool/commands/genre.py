"""showrunner genre - genre preset management commands."""
...
from showrunner_tool.core.genre_presets import get_preset, list_presets, get_preset_ids
...
def show_genre(
    ...
    if not preset:
        print_error(f"Unknown genre: {genre_id}. Use 'showrunner genre list' to see options.")
        raise typer.Exit(1)
