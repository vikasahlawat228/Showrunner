"""antigravity story - story structure commands."""
...
def show() -> None:
    ...
    if not structure:
        print_info("No story structure found. Run 'antigravity story outline' first.")
        return
...
def list_arcs() -> None:
    ...
    if not structure or not structure.sub_arcs:
        print_info("No sub-arcs defined. Use 'antigravity story add-arc' to create one.")
        return
...
def show_arc(
    ...
    if arc.beats:
        ...
        print_info("No beats defined yet. Generate them with 'antigravity story add-arc' planning prompt.")
