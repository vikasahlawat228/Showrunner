"""Root CLI application for Antigravity."""

from __future__ import annotations

import typer

from antigravity_tool.commands import (
    init_cmd,
    world,
    character,
    story,
...
from antigravity_tool.utils.display import console, create_table, print_info
...
def status() -> None:
    ...
    try:
        ...
        print_info("No project found. Run 'antigravity init <name>' to create one.")
        return
