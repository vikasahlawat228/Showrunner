...
from antigravity_tool.schemas.story_structure import StoryStructure, SubArc, SubArcType
...
class StoryService:
    ...
    def add_sub_arc(
        ...
        if not structure:
            from antigravity_tool.errors import WorkflowError
            raise WorkflowError("No story structure found. Run 'antigravity story outline' first.")
